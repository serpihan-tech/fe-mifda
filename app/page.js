  ...
  return (
    <div className="w-full h-full items-center justify-center flex flex-col">
      ...
      <button
        ...
        className="w-1/3 mt-10 text-neutral-100 bg-[#146168] text-xl rounded-xl py-2.5 font-semibold hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out"
      >
        Log in
      </button>
      <div className="flex mt-5">
        <Link href="/dashboard" className="text-blue-600 underline group">
